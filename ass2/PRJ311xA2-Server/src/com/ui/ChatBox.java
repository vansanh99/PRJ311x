...
public class ChatBox extends javax.swing.JDialog {
    ...
    public void setUsername(String username) {
        ...
        cs.setTxtContent(txtContentServerBox);
        new Thread(cs).start();
    ...
    private void initComponents() {
        ...
        txtContentServerBox = new javax.swing.JTextArea();
        txtMessage = new javax.swing.JTextField();
        btnSend = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        txtContentServerBox.setColumns(20);
        txtContentServerBox.setRows(5);
        jScrollPane1.setViewportView(txtContentServerBox);
    ...
    private javax.swing.JTextArea txtContentServerBox;
